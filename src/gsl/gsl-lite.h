...
//
// Checkout date: 2016-05-25
// Revision URL: https://github.com/martinmoene/gsl-lite/commit/d5b1a27
//
...
//
// Asserting removed temporary, by Eyal Rozenberg 2016-05-26
#define Expects(x)
#define Ensures(x)
...
public:
    ...
    gsl_constexpr14 span< value_type > subspan( size_type offset, size_type count ) const gsl_noexcept
    {
